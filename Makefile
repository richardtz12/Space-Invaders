...
OFILES = main.o mylib.o spaceinvaders.o  tank20.o victoryscreen.o gameoverscreen.o text.o
# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space separated list of .h files
HFILES = myLib.h DMA.h spaceinvaders.h tank20.h victoryscreen.h text.h gameoverscreen.h text.h
